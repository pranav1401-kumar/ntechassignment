  ...
  const providers = [
    {
      ...
      enabled: process.env.REACT_APP_ENABLE_GOOGLE_AUTH === 'true',
    },
    {
      ...
      enabled: process.env.REACT_APP_ENABLE_GITHUB_AUTH === 'true',
    },
    {
      name: OAUTH_PROVIDERS.MICROSOFT,
      label: 'Microsoft',
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24">
      ...
      enabled: process.env.REACT_APP_ENABLE_MICROSOFT_AUTH === 'true',
    },
  ];
